...
test("list of streets titles of government building", () => {
  const streets = getStreetTitlesOfGovernmentBuildings(city.governmentBuildings);
...
test("list of streets titles of houses", () => {
  const streets = getStreetTitlesOfHouses(city.houses);
